namespace Dreamteck.Splines.Editor
{
    ...
    public class DreamteckSplinesEditor : SplineEditor
    {
        ...
        public DreamteckSplinesEditor(SplineComputer splineComputer, SerializedObject splineHolder) : base (splineComputer.transform.localToWorldMatrix, splineHolder)
        {
